...
<html>
	...
	<body>
        <nav class="navtop">
            <div>
                <h1>Contact Form</h1>
                <a href="minimal.html"><i class="fas fa-angle-right"></i>Minimal</a>
                <a href="index.html"><i class="fas fa-angle-right"></i>Advanced</a>
                <a href="recaptcha.html"><i class="fas fa-angle-right"></i>reCAPTCHA</a>
